                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:15px 10px 20px 15px;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <div class="v-text-align"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 170%;"><span
                                                                        style="font-family: helvetica, sans-serif; font-size: 16px; line-height: 27.2px;"> لتحديث كلمة المرور في تطبيق يافورم الرجاء الدخول علي هذا الرابط <br /> <b>{{$code}} </b> <br /> </span></p>
                                                            </div>
                                                                ...
                                                                <a href="{{$reset_link}}" target="_blank"
                                                                    ...
                                                                    <span
                                                                        style="display:block;padding:13px 30px;line-height:120%;"><span
                                                                            style="font-size: 16px; line-height: 19.2px;">Reset password
                                                                            </span></span>
                                                                </a>
                                                            ...
                                                            <table width="100%" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td class="v-text-align"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="{{asset('images/mails/verification/image-3.png')}}" alt="test"
                                                                            title="Image"
                                                                            style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 46px;"
                                                                            width="46"
                                                                            class="v-src-width v-src-max-width" />
