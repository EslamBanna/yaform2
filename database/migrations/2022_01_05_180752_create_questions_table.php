...
class CreateQuestionsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('questions', function (Blueprint $table) {
            ...
            $table->enum('question_type',['0','1','2','3'])->comment('0 => Short answer, 1 => Paragraph, 2 => Multiple choice, 3=> Checkboxes, 4 => Dropdown, 5 => Date, 6 => Time, 7 => Phone number, 8 => Email, 9 => Name, 10 => Number');
